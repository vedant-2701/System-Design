...
### Concurrency Basics
- [R] Mutex, Semaphore, Spinlock
- [I] Deadlock, Livelock, Starvation
- [I] Thread Pools
- [I] Async/Await vs Threads vs Event Loop
- [R] Memory Visibility & Happens-Before
- [I] Compare-and-Swap (CAS)
- [I] Amdahl's Law

### Linux Basics
- [R] File System Structure
- [R] Permissions & Ownership
- [R] Process Management (ps, kill, top)
- [R] Networking Tools (netstat, ss, tcpdump)
- [R] Systemd & Services
- [I] Shell Scripting Essentials
- [I] cron Jobs
- [I] Log Inspection (/var/log, journalctl)

### Networking & TCP/IP
- [I] OSI Model and TCP/IP model
- [I] IP Addressing, Subnets, CIDR
- [I] TCP 3-Way Handshake
- [I] UDP vs TCP
- [I] Ports and Sockets
- [I] NAT & Routing
- [I] ICMP, ping, traceroute
- [R] TCP Congestion Control
- [R] TIME_WAIT State

### HTTP/HTTPS & TLS/SSL
- [I] HTTP/1.1 vs HTTP/2 vs HTTP/3
- [I] Request/Response Lifecycle
- [I] Status Codes (1xx–5xx)
- [R] Headers (Auth, Caching, Content Negotiation)
- [I] Cookies & Sessions
- [R] TLS Handshake
- [R] Certificate Chain & CA
- [R] HSTS
- [I] CORS

### DNS
- [I] DNS Resolution Chain
- [I] Record Types (A, AAAA, CNAME, MX, TXT)
- [I] TTL and Caching
- [I] Recursive vs Authoritative Resolvers
- [I] DNS Propagation
- [R] GeoDNS
- [R] DNS-Based Load Balancing
- [I] DNSSEC Basics

### REST APIs
- [I] REST Constraints & Richardson Maturity Model
- [I] Idempotency of HTTP Verbs
- [I] API Versioning Strategies
- [I] Pagination (Cursor vs Offset)
- [I] HATEOAS
- [I] OpenAPI / Swagger
...
### OOP Fundamentals
- [I] Encapsulation, Abstraction, Inheritance, Polymorphism
- [I] Composition over Inheritance
- [I] Interface vs Abstract Class
- [I] Method Overloading vs Overriding
- [I] Static vs Instance Members
- [I] Object Lifecycle
